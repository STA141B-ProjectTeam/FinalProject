...
<p>At the introductory stage, taking into account different attitudes and paces of the project team members, it was decided to create several dedicated tabs within the main pane. Team members have their own place for presenting their work there.
...
<h2>Prototyping. Testing. Deployment.</h2>

<p>Initial prototype is available at https://sta141b.shinyapps.io/FinalPro/
<p>Project deliverables include source code repository, documentation, and working copies of the application available on the web. The copies of the application have to be deployed on shinyapps.io as per the requirements. Due to the limitations of Amadeus test API and other resources, testing of the application is limited to ad-hoc method. Each team member is supposed to deploy their own copy of the application.  
